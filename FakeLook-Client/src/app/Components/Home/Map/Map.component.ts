        ...
        navigator.geolocation.getCurrentPosition((location) => {
          ...
          this.displayPosts.forEach(element => {
            ...
            var information = new google.maps.InfoWindow({
              content: `<div><div class="userPostDetails"><h1>blbllb : </h1><img src=${element.PhotoUrl}></div><div class="post-detailes"><p>${element.Content}</p><p>Publish Date</p> <p>Number Of Likes ""</p><button>Like</button></div></div>`
            });
